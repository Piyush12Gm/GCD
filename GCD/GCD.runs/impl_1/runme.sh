...
HD_PWD='C:/Users/anura/AMAN/GCD/GCD.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log data_path.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source data_path.tcl -notrace
